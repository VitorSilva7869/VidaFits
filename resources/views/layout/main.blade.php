            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center div2" id="navbarText">
                    ...
                    <ul class="nav-link">
                        ...
                        <li class=""><a  href="meditar.html">Meditar</a></li>
                        <li class=""><a  href="eventos.html">Eventos</a></li>
                    </ul>
                </div>
                
                <div class="icone div3">
                    <a href="pesquiser.html" class="icone-style-nav">
                        <i class="fa-solid fa-magnifying-glass fa-xl "></i>
                    </a>
                    <!--
                    <a href="login.html" class="icone-style-nav">
                            ...
                            <div class="container-dropdown">
                                <div class="container-name d-flex align-items-center">
                                    <div class="dropdown-name d-block">
                                        <h4>Vitor Silva</h4>
                                        <p>vss78696546@gmail.com</p>
                                    </div>
                                    <img src="/image/mundo.png" alt="">
                                </div>
                                <li><button type="button"><i class="fa-solid fa-arrow-right-from-bracket me-2"></i>Logout</button></li>
                            </div>
                        </ul>
                    </div>
                </div>
